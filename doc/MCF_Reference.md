...
rights|Mandatory|Information about rights held in and over the resource. The $date$ variable instead of yearvalue to update to current year at Subversion commit time. |Copyright (c) 2010 Her Majesty the Queen in Right of Canada|DMCI 1.1
