...
datetype|Mandatory|date used for the reference date (must be one of 'revision', 'publication', 'creation'), use 'creation' when the date identifies when the resource was brought into existence, use 'publication' when the date identifies when the resource was issued, and use 'revision' when the date identifies when the resource was examined or re-examined and improved or amended|creation|ISO 19115:2003 Section B.3.2.4
